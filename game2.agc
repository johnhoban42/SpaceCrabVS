...
function CreateGame2()
	...
	evilS$ = ""
	if crab2evil then evilS$ = "2"
	if GetFileExists("crab" + str(crab2Type) + AltStr(crab2Alt) + evilS$ + "special1.png")
		LoadAnimatedSprite(specialButton2, "crab" + str(crab2Type) + AltStr(crab2Alt) + evilS$ + "special", 5)
	else
...
function DoGame2()
	...
	if specialTimerAgainst2# > 0 and crab1Type = 4
		for i = special1Ex1 to special1Ex5
			...
			if crab1Alt = 1 or (crab1Alt = 3 and crab1Evil) then SetSpriteColorByCycleA(i, specialTimerAgainst2#)
		next i
...
function SendSpecial2()
	...
	elseif crab2Type = 5
		...
		if GetSpriteExists(special2Ex1) = 0
			SetFolder("/media/ui")
			LoadSpriteExpress(special2Ex1, "clockhand4" + AltStr(crab2Alt) + "2.png", 100*gameScale#, 100*gameScale#, -100, -100, 6)	//Minute hand
			LoadSpriteExpress(special2Ex2, "clockhand4" + AltStr(crab2Alt) + "1.png", 100*gameScale#, 100*gameScale#, -100, -100, 6)	//Hour hand
			LoadSpriteExpress(special2Ex3, "clock4" + AltStr(crab2Alt) + ".png", 100*gameScale#, 100*gameScale#, -200, -200, 7)	//Clock
		endif
